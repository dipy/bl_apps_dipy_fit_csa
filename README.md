...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-bl.app.61-blue.svg)](https://doi.org/10.25663/brainlife.app.61)

# Dipy Reconstruction Diffusion MRI using CSA

The App uses the Constant Solid Angle (CSA) method to do a reconstruction of the diffusion-weighted magnetic resonance imaging data.
...
### DIPY
- This is a Brainlife wrapper App stemming from the [`dipy_fit_csa`](https://dipy.org/documentation/latest/reference_cmd/dipy_fit_csa/) workflow.
